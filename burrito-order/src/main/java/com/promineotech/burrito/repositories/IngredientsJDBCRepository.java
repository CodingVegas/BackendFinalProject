...
public class IngredientsJDBCRepository implements IngredientsRepository {
  ...
  public Optional<Ingredients> delete(String ingredientsPK) {
    ...
    if (existing.isPresent()) { 
      String sql = "DELETE burrito_ingredients.*, ingredients.* FROM burrito_ingredients,ingredients WHERE burrito_ingredients.ingredients_pk = :ingredients_pk AND ingredients.ingredients_pk = :ingredients_pk;";
